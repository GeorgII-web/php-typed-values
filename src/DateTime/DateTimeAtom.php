...
class DateTimeAtom extends DateTimeTypeAbstract
{
    ...
    {
        throw new DateTimeTypeException('DateTimeAtom type cannot be created from null');
    }
    ...
    {
        throw new DateTimeTypeException('DateTimeAtom type cannot be converted to null');
    }
