 ...
 * @psalm-immutable
 */
class FloatPercent extends FloatTypeAbstract
{
    /**
     * @readonly
     */
    ...
    {
        throw new PercentFloatTypeException('Float type cannot be created from null');
    }
    ...
    {
        throw new PercentFloatTypeException('Float type cannot be converted to null');
    }
