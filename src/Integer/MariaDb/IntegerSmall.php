...
class IntegerSmall extends IntegerTypeAbstract
{
    ...
    {
        throw new SmallIntegerTypeException('Integer type cannot be created from null');
    }
    ...
    {
        throw new SmallIntegerTypeException('Integer type cannot be converted to null');
    }
