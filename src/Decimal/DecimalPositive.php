...
/**
 * DECIMAL positive value encoded as a string.
 *
 ...
 *
 * Example
 *  - $d = DecimalPositive::fromString('3.14');
 *    $d->toString(); // '3.14'
 *  - DecimalPositive::fromString('abc'); // throws DecimalTypeException
 *
 ...
 * @psalm-immutable
 */
readonly class DecimalPositive extends DecimalTypeAbstract
{
    /**
    ...
    {
        throw new PositiveDecimalTypeException('Value cannot be null');
    }
