 ...
 * @psalm-immutable
 */
class StringText extends StringTypeAbstract
{
    /**
     * @readonly
     */
    ...
    {
        throw new StringTypeException('StringText type cannot be created from null');
    }
    ...
    {
        throw new StringTypeException('StringText type cannot be converted to null');
    }
