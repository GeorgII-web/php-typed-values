...
/**
 * Date-time value formatted using PHP's DATE_RFC1123 (RFC 1123).
 *
 ...
 * formatting using DATE_RFC1123.
 *
 * Example
 *  - $v = DateTimeRFC1123::fromString('Mon, 15 Aug 2005 15:52:01 +0000');
 *    $v->toString(); // "Mon, 15 Aug 2005 15:52:01 +0000"
 *
 * @psalm-immutable
 */
class DateTimeRFC1123 extends DateTimeTypeAbstract
{
    /**
     * @var string
     */
    public const FORMAT = DATE_RFC1123;
    ...
    /**
     * @throws RFC1123DateTimeTypeException
     * @return never
     */
    public static function fromNull(null $value)
    {
        throw new RFC1123DateTimeTypeException('DateTimeRFC1123 type cannot be created from null');
    }
     ...
     * @return static
     */
    public static function fromString(string $value, string $timezone = self::DEFAULT_ZONE): self
    {
        try {
            return new static(
            ...
            throw new RFC1123DateTimeTypeException($e->getMessage(), $e->getCode(), $e);
        }
    }
    ...
    {
        throw new RFC1123DateTimeTypeException('DateTimeRFC1123 type cannot be converted to null');
    }
