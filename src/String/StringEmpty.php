 ...
 * @psalm-immutable
 */
class StringEmpty extends StringTypeAbstract
{
    /**
    ...
    {
        throw new StringTypeException('StringEmpty type cannot be created from null');
    }
    ...
    {
        throw new StringTypeException('StringEmpty type cannot be converted to null');
    }
