 ...
 * true/false synonyms, alongside strictly managing "yes" and "no" as labels.
 *
 * @psalm-immutable
 */
readonly class BoolToggle extends BoolTypeAbstract
{
    ...
    public static function fromLabel(string $label): static
    {
        $value = match ($label) {
            'yes' => true,
            'no' => false,
            default => throw new ToggleBoolTypeException(sprintf('Expected boolean toggle label "yes" or "no", got "%s"', $label)),
        };
    ...
    public static function tryFromMixed(
        ...
        try {
            ...
            return match (true) {
                ...
                is_string($value) || $value instanceof Stringable => static::tryFromLabel((string) $value, static::tryFromString((string) $value)),
