 ...
 * @psalm-immutable
 */
readonly class StringUuidV7 extends StringTypeAbstract
{
    ...
    {
        throw new UuidStringTypeException('StringUuidV7 type cannot be created from null');
    }
    ...
    {
        throw new UuidStringTypeException('StringUuidV7 type cannot be converted to null');
    }
