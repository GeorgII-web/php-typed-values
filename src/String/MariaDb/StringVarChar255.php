 ...
 * @psalm-immutable
 */
class StringVarChar255 extends StringTypeAbstract
{
    /**
     * @readonly
     */
    ...
    {
        throw new StringTypeException('StringVarChar255 type cannot be created from null');
    }
    ...
    {
        throw new StringTypeException('StringVarChar255 type cannot be converted to null');
    }
