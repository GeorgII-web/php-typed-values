...
/**
 * IntegerMedium (Database medium integer MEDIUMINT signed: -8388608..8388607).
 *
 * Represents a mediumint value in the signed range -8388608..8388607, matching common
 * MariaDB/MySQL semantics. Factories accept strictly validated strings and
 * native ints and enforce the bounds.
 *
 * Example
 *  - $v = IntegerMedium::fromString('-5');
 *    $v->value(); // -5
 *  - $v = IntegerMedium::fromInt(8388607);
 *    (string) $v; // "8388607"
 *
 * @psalm-immutable
 */
readonly class IntegerMedium extends IntegerTypeAbstract
{
    ...
    public function __construct(int $value)
    {
        if ($value < -8388608 || $value > 8388607) {
            throw new MediumIntegerTypeException(sprintf('Expected medium integer in range -8388608..8388607, got "%d"', $value));
        }
