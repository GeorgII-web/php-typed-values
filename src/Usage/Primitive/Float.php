...
// * @coversNothing
// */
// readonly class Float extends PrimitiveTypeAbstract
// {
//    public function __construct(private float $val)
//    {
//    }
//
//    public static function floatToStringTest(self $value, $roundTripConversion = true): string
//    {
...
//    }
//
//    public static function stringToFloatTest(string $value, $roundTripConversion = true): self
//    {
...
//    try {
//        $got = Conversion::stringToFloatTest((string) $src);
//    } catch (Exception) {
//        $got = null;
//    }
//
...
//
//    try {
//        $got = Conversion::floatToStringTest($src);
//    } catch (Exception) {
//        $got = null;
//    }
//
