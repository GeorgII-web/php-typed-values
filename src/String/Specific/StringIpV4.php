...
/**
 * String IPv4 typed value.
 *
 * Wraps a string and validates it as a valid IPv4 address.
 *
 * Example
 ...
 * @psalm-immutable
 */
readonly class StringIpV4 extends StringTypeAbstract
{
    protected string $value;

    /**
     * @throws IpV4StringException
     */
    public function __construct(string $value)
    {
        if (filter_var($value, FILTER_VALIDATE_IP, FILTER_FLAG_IPV4) === false) {
            throw new IpV4StringException(sprintf('Invalid IPv4 address: %s', $value));
        }
    ...
    {
        throw new IpV4StringException('StringIpV4 type cannot be created from null');
    }
    ...
    {
        throw new IpV4StringException('StringIpV4 type cannot be converted to null');
    }
