...
it('isEmpty is always false for DateTimeRFC3339', function (): void {
    $vo = DateTimeRFC3339::fromString('2025-01-02T03:04:05+00:00');
...
it('tryFromString and tryFromMixed accept custom timezone', function (): void {
    ...
    $vo1 = DateTimeRFC3339::tryFromString($s, 'Europe/Berlin');
    expect($vo1)->toBeInstanceOf(DateTimeRFC3339::class)
        ->and($vo1->toString())->toBe('2025-01-02T03:04:05+00:00')
        ->and($vo1->value()->getOffset())->toBe(0);

    $vo2 = DateTimeRFC3339::tryFromMixed($s, 'Europe/Berlin');
    expect($vo2)->toBeInstanceOf(DateTimeRFC3339::class)
        ->and($vo2->toString())->toBe('2025-01-02T03:04:05+00:00')
...
it('tryFromMixed handles DateTimeImmutable instance', function (): void {
    $dt = new DateTimeImmutable('2025-01-02T03:04:05+00:00');
    $result = DateTimeRFC3339::tryFromMixed($dt);
...
it('tryFromMixed handles Stringable object', function (): void {
    ...
    $result = DateTimeRFC3339::tryFromMixed($stringable);
...
it('tryFromMixed returns Undefined for non-Stringable objects', function (): void {
    $obj = new stdClass();
    $result = DateTimeRFC3339::tryFromMixed($obj);
