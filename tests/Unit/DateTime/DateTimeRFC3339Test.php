...
covers(DateTimeRFC3339::class);

describe('DateTimeRFC3339', function () {
    describe('Creation', function () {
        describe('fromDateTime', function () {
            it('returns same instant and toString is RFC3339', function () {
        ...
        describe('fromString', function () {
            ...
            it('accepts custom timezone', function () {
                $vo = DateTimeRFC3339::fromString('2025-01-02T04:04:05+01:00', 'Europe/Berlin');
            ...
            it('throws exception on invalid input', function (string $input, string $containedMessage) {
                expect(fn() => DateTimeRFC3339::fromString($input))
        ...
        describe('tryFromString', function () {
            it('returns instance or default value', function (string $input, string $tz, bool $isSuccess) {
                ...
                if ($isSuccess) {
                    expect($result)->toBeInstanceOf(DateTimeRFC3339::class)
        ...
        describe('tryFromMixed', function () {
            ...
            it('returns Undefined for invalid mixed inputs', function (mixed $input) {
                $result = DateTimeRFC3339::tryFromMixed($input);
                expect($result)->toBeInstanceOf(Undefined::class)
    ...
    describe('Instance Methods', function () {
        ...
        it('toString and __toString return RFC3339 formatted string', function () {
            $s = '2025-01-02T03:04:05+00:00';
            $vo = DateTimeRFC3339::fromString($s);
        ...
        it('jsonSerialize returns string', function () {
            $s = '2025-01-02T03:04:05+00:00';
            expect(DateTimeRFC3339::fromString($s)->jsonSerialize())->toBe($s);
        });
        ...
        describe('withTimeZone', function () {
            it('returns a new instance with updated timezone (normalized to UTC)', function () {
                ...
                expect($vo2)->toBeInstanceOf(DateTimeRFC3339::class)
        ...
        describe('isTypeOf', function () {
            it('returns true when class matches', function () {
                $vo = DateTimeRFC3339::fromString('2025-01-02T03:04:05+00:00');
                expect($vo->isTypeOf(DateTimeRFC3339::class))->toBeTrue();
            });
            ...
            it('returns true for multiple classNames when one matches', function () {
                $vo = DateTimeRFC3339::fromString('2025-01-02T03:04:05+00:00');
                expect($vo->isTypeOf('NonExistentClass', DateTimeRFC3339::class, 'AnotherClass'))->toBeTrue();
            });
        });
    });
});
