...
/**
 * Non-positive float-typed value (<= 0.0).
 *
 * @psalm-immutable
 */
readonly class FloatNonPositive extends FloatTypeAbstract
{
    ...
    {
        if ($value > 0.0) {
            throw new NonPositiveFloatTypeException(sprintf('Expected non-positive float, got "%s"', $value));
        }

        if (is_infinite($value)) {
            throw new NonPositiveFloatTypeException('Infinite float value');
        }

        if (is_nan($value)) {
            throw new NonPositiveFloatTypeException('Not a number float value');
        }
    ...
    {
        throw new NonPositiveFloatTypeException('Float type cannot be created from null');
    }
    ...
    {
        throw new NonPositiveFloatTypeException('Float type cannot be converted to null');
    }
