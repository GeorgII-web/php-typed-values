...
abstract class UndefinedTypeAbstract extends PrimitiveTypeAbstract implements UndefinedTypeInterface
{
     ...
     * @return static
     */
    abstract public static function fromBool(bool $value): self;

    /**
     * @throws UndefinedTypeException
     * @return static
     */
    abstract public static function fromDecimal(string $value): self;
     ...
     * @return static
     */
    abstract public static function fromInt(int $value): self;

    /**
     * @return static
     */
    abstract public static function fromNull(null $value): self;
