...
namespace Base\Primitive\Undefined;
...
/**
 * Mock implementation of UndefinedTypeAbstract that returns a value from toString.
 */
readonly class UndefinedTypeSuccessMock extends UndefinedTypeAbstract
{
    public static function create(): static
    {
        return new static();
...
describe('UndefinedTypeAbstract', function () {
    ...
    describe('__toString behavior', function () {
        ...
        it('returns value from toString if it does not throw', function (): void {
